...
/**
 * Extension function for String to capitalize the first letter of each word.
 */
// Function to capitalize the first letter of each word in a string without extension
fun capitalizeWords(str: String): String =
  str.split(" ").joinToString(" ") { it.replaceFirstChar { c -> c.uppercaseChar() } }

fun String.capitalizeWordsExtenisionFn(): String =
...
private val capitalizedWithExtension = name.capitalizeWordsExtenisionFn() // "John Doe"
